...
export const DEMO_SCHOOLS = [
  {
    ...
    managerEmail: "cace@demo.cl",
  },
  { id: "sch_2", code: "CAMV", name: "Colegio A. M. V.", managerName: "Encargado/a", managerEmail: "camv@demo.cl" },
  { id: "sch_3", code: "CCOC", name: "Colegio C. O. C.", managerName: "Encargado/a", managerEmail: "ccoc@demo.cl" },
  {
    id: "sch_4",
    code: "CJFF",
    name: "Colegio J. F. F.",
    managerName: "Encargado/a",
    managerEmail: "cjff@demo.cl",
  },
  { id: "sch_5", code: "CJLU", name: "Colegio J. L. U.", managerName: "Encargado/a", managerEmail: "cjlu@demo.cl" },
  { id: "sch_6", code: "CJMC", name: "Colegio J. M. C.", managerName: "Encargado/a", managerEmail: "cjmc@demo.cl" },
  {
    id: "sch_7",
    code: "CLSM",
    name: "Colegio L. S. M.",
    managerName: "Encargado/a",
    managerEmail: "clsm@demo.cl",
  },
  { id: "sch_8", code: "CPDM", name: "Colegio P. D. M.", managerName: "Encargado/a", managerEmail: "cpdm@demo.cl" },
  { id: "sch_9", code: "CRSH", name: "Colegio R. S. H.", managerName: "Encargado/a", managerEmail: "crsh@demo.cl" },
  {
    id: "sch_10",
    code: "CSAH",
    name: "Colegio S. A. H.",
    managerName: "Encargado/a",
    managerEmail: "csah@demo.cl",
  },
  { id: "sch_11", code: "CSDM", name: "Colegio S. D. M.", managerName: "Encargado/a", managerEmail: "csdm@demo.cl" },
  { id: "sch_12", code: "CSFA", name: "Colegio S. F. A.", managerName: "Encargado/a", managerEmail: "csfa@demo.cl" },
];
