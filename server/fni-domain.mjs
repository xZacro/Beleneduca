...
export const DEMO_SCHOOLS = [
  {
    ...
    name: "Casa Central",
    managerName: null,
    managerEmail: "cc@beleneduca.cl",
  },
  {
    id: "sch_1",
    code: "CACE",
    name: "Colegio Arzobispo Crescente Errazuriz",
    managerName: "Paola Pontillo",
    managerEmail: "ppontillo@beleneduca.cl",
  },
  {
    id: "sch_2",
    code: "CAMV",
    name: "Colegio Arzobispo Manuel Vicuña",
    managerName: "Kimberly Orellana Bonilla",
    managerEmail: "kimberly.orellana@beleneduca.cl",
  },
  {
    id: "sch_3",
    code: "CCOC",
    name: "Colegio Carlos Oviedo Cavada",
    managerName: "Romina Paz Correa Pino",
    managerEmail: "romina.correa@beleneduca.cl",
  },
  {
    id: "sch_4",
    code: "CJFF",
    name: "Colegio Juan Francisco Fresno",
    managerName: "Andrea Espinoza Pino",
    managerEmail: "aespinoza@beleneduca.cl",
  },
  {
    id: "sch_5",
    code: "CJLU",
    name: "Colegio Juan Luis Undurraga",
    managerName: null,
    managerEmail: "cjlu@beleneduca.cl",
  },
  {
    id: "sch_6",
    code: "CJMC",
    name: "Colegio José María Caro",
    managerName: "Carolina Andrea Fuentes Henriquez",
    managerEmail: "carolina.fuentes@beleneduca.cl",
  },
  {
    id: "sch_7",
    code: "CLS",
    name: "Colegio Lorenzo Sazié de Molokai",
    managerName: "Carolina Dennisse Osses Figueroa",
    managerEmail: "carolina.osses@molokai.cl",
  },
  {
    id: "sch_8",
    code: "CPD",
    name: "Colegio Padre Damián de Molokai",
    managerName: "José Vitalicio Gonzalez Miranda",
    managerEmail: "jgonzalez@molokai.cl",
  },
  {
    id: "sch_9",
    code: "CRSH",
    name: "Colegio Raúl Silva Henríquez",
    managerName: "Roxanna Fuentes Rojas",
    managerEmail: "rfuentes@beleneduca.cl",
  },
  {
    id: "sch_10",
    code: "CSAH",
    name: "Colegio San Alberto Hurtado",
    managerName: "María Paz Carbonell Muñoz",
    managerEmail: "mariapaz.carbonell@beleneduca.cl",
  },
  {
    id: "sch_11",
    code: "CSDM",
    name: "Colegio San Damián de Molokai",
    managerName: "Marjorie Espinoza Rojas",
    managerEmail: "marjorie.espinoza@molokai.cl",
  },
  {
    id: "sch_12",
    code: "CSFA",
    name: "Colegio San Francisco de Asís de Molokai",
    managerName: "Nadia Lorena Sandoval Toledo",
    managerEmail: "nadia.sandoval@molokai.cl",
  },
];
